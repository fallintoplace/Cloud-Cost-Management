      ...
      <div className="flex items-center">
        ...
        <div className="flex items-center ml-6">
          <div className="bg-white h-8 w-8 rounded-full overflow-hidden">
            <img src="https://nordcloud.com/wp-content/uploads/2021/09/ninja-1.png" alt="User Avatar" />
          </div>
        ...
        <div className="flex items-center ml-6">
          <div className="relative">
            ...
            <div className="absolute top-0 right-0 transform translate-x-1/2 -translate-y-1/2 bg-red-500 text-white rounded-full h-6 w-6 flex items-center justify-center text-sm font-bold">2</div>
          </div>
        </div>
      </div>
    </nav>
